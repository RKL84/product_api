using Autofac;
using BigPurpleBank.Common.EventBus;
using BigPurpleBank.Common.EventBus.Abstractions;
using BigPurpleBank.Common.EventBusRabbitMQ;
using BigPurpleBank.Common.EventBusServiceBus;
...
using BigPurpleBank.Product.API.Infrastructure.Filters;
    ...
    public static class StartupExtensions
    {
            ...
            (this IServiceCollection services, IConfiguration configuration)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "Big Purple Bank - Product HTTP API",
                    Version = "v1",
